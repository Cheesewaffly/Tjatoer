...
class GameState:
    ...
    def makemove(self, move):
        ...
        # promosi pion (pawn promotion, can only promote to queen)
        if move.ispawnpromotion:
            self.board[move.endrow][move.endcol] = move.piecemoved[0] + 'Q'

        # promosi man (man promotion, can only promote to lance)
        elif move.ismanpromotion:
            self.board[move.endrow][move.endcol] = move.piecemoved[0] + 'L'

        # promosi shrook (shrook promotion)
        elif move.isshrookpromotion:
            self.board[move.endrow][move.endcol] = move.piecemoved[0] + 'R'

        # promosi thalia (thalia promotion)
        elif move.isthaliapromotion:
            self.board[move.endrow][move.endcol] = move.piecemoved[0] + 'B'

        # promosi warrior (warrior promotion)
        elif move.iswarriorpromotion:
    ...
    def getpawnmoves(self, r, c, moves):
        if self.whitetomove:  # pion putih (white pawn)
            if self.board[r - 1][c] == "--":  # maju 1 petak (move 1 squre forward)
                ...
                if r == 12 and self.board[r - 2][c] == "--":  # maju 4 petak di langkah pertama (moves upto 4 squares forward in the first move)
            ...
            if self.board[r + 1][c] == "--":  # maju 1 petak (move 1 squre forward)
                moves.append(Move((r, c), (r + 1, c), self.board))
                if r == 3 and self.board[r + 2][c] == "--":  # maju 4 petak di langkah pertama (moves upto 4 squares forward in the first move)
                    moves.append(Move((r, c), (r + 2, c), self.board))
                    if self.board[r + 3][c] == "--":
                        moves.append(Move((r, c), (r + 3, c), self.board))
                        if self.board[r + 4][c] == "--":
...
class Move:
    ...
    def __init__(self, startsq, endsq, board):
        ...
        self.ismanpromotion = (self.piecemoved == 'wM' and self.endrow == 0) or (
                self.piecemoved == 'bM' and self.endrow == 15)
        self.isshrookpromotion = (self.piecemoved == 'wS' and self.endrow == 0) or (
                self.piecemoved == 'bS' and self.endrow == 15)
        self.isthaliapromotion = (self.piecemoved == 'wT' and self.endrow == 0) or (
                self.piecemoved == 'bT' and self.endrow == 15)
        self.iswarriorpromotion = (self.piecemoved == 'wW' and self.endrow == 0) or (
                self.piecemoved == 'bW' and self.endrow == 15)
    ...
    def __str__(self):
        ...
        if self.piecemoved[1] == 'P':
            ...
            return (
                pawnmovestring + 'x' + endsquare + '=Q' if self.ispawnpromotion else pawnmovestring + 'x' + endsquare) if self.iscapture else (
                endsquare + '=Q' if self.ispawnpromotion else endsquare)
        elif self.piecemoved[1] == 'M':
            manmovestring = self.piecemoved[1]
            return (
                manmovestring + 'x' + endsquare + '=L' if self.ismanpromotion else manmovestring + 'x' + endsquare) if self.iscapture else (
                manmovestring + endsquare + '=L' if self.ismanpromotion else manmovestring + endsquare)
        elif self.piecemoved[1] == 'S':
            shrookmovestring = self.piecemoved[1]
            return (
                shrookmovestring + 'x' + endsquare + '=R' if self.isshrookpromotion else shrookmovestring + 'x' + endsquare) if self.iscapture else (
                shrookmovestring + endsquare + '=R' if self.isshrookpromotion else shrookmovestring + endsquare)
        elif self.piecemoved[1] == 'T':
            thaliamovestring = self.piecemoved[1]
            return (
                thaliamovestring + 'x' + endsquare + '=B' if self.isthaliapromotion else thaliamovestring + 'x' + endsquare) if self.iscapture else (
                thaliamovestring + endsquare + '=B' if self.isthaliapromotion else thaliamovestring + endsquare)
        elif self.piecemoved[1] == 'W':
            warriormovestring = self.piecemoved[1]
            return (
                warriormovestring + 'x' + endsquare + '=N' if self.iswarriorpromotion else warriormovestring + 'x' + endsquare) if self.iscapture else (
                warriormovestring + endsquare + '=N' if self.iswarriorpromotion else warriormovestring + endsquare)
