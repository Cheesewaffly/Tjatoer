...
def main():
    ...
    gameover = False
    playerone = False  # kalo manusia putih maka true, sebaliknya false (if human is white then true, else false)
    playertwo = False  # kalo manusia hitam maka true, sebaliknya false (if human is black then true, else false)
    aithinking = False
